...
def build_system_prompt(language: str) -> str:
    ...
    return (
        ...
        "禁止只靠自己知識編答案。\n"
        "   (d) 使用者訊息以「以下為使用者傳送的image/video/audio/file媒體內容：」等媒體前綴開頭 → "
