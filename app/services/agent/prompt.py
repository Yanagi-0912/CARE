...
def build_system_prompt(language: str) -> str:
    ...
    return (
        ...
        "若使用者在本輪或稍早的對話中用了「大醫院」「大型醫院」「住院」"
        "「診所」「小診所」「藥局」「藥房」「藥店」等明確語彙，"
        "才把該原始說法填入 `facility_type`（例如「大醫院」，不要自行換算成"
        "「醫院」）；`facility_type` 可與 `department` 同時帶入。"
        ...
        "`find_nearby_facilities_by_department`、`lookup_medical_facility` 或 "
