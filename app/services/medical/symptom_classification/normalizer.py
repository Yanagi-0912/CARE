...
# 嬰幼兒指涉。用途只有一個：成人帳號幫寶寶問時，年齡欄位是家長的，光看年齡會把
# 兒科濾掉。
#
# 親屬稱謂不代表年齡：「兒子」可能已成年，「妹妹」也可能是成人；「小孩」在口語
# 中也常只是親子關係。為避免把成年人的症狀導向兒科，只保留年齡語意相對明確的
# 「寶寶」。訊息中的「XX歲」目前不在這裡解析。
_CHILD_REFERENCE_RE = re.compile(r"寶寶")
