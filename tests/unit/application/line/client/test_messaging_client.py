...
from app.application.line.client.messaging_client import LineMessagingClient
...
def test_reply_message_calls_line_sdk_with_access_token():
    ...
    with patch(
        "app.application.line.client.messaging_client.Configuration"
    ) as mock_config, patch(
        "app.application.line.client.messaging_client.ApiClient",
        return_value=api_client_cm,
    ) as mock_api_client, patch(
        "app.application.line.client.messaging_client.MessagingApi",
