...
from app.services.vector_search.config import VectorSearchConfig
from app.services.vector_search.reader import MongoVectorSearchReader
...
async def test_search_by_embedding_maps_docs_to_hits():
    ...
    with patch(
        "app.services.vector_search.reader.build_vector_search_pipeline",
...
def test_ensure_collection_creates_motor_collection_once():
    ...
    with patch(
        "app.services.vector_search.reader.AsyncIOMotorClient",
